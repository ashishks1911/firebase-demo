      ...
      <div className='d-flex justify-content-center align-items-center' style={{height:'90vh'}}>
        ...
        <div className={`${styles['form-signin']} w-100 m-auto`}>
          <div>
            ...
            <button className="btn btn-primary w-100 py-2" onClick={signIn}> Sign Up</button>
            <p className='text-center mt-1'>Existing user ? click <Link to={'/login'}>here</Link> to Log In</p>
